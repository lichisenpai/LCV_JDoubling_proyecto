...
def new_data (d, WW, E, S, D, sn, E2): #Escribir los datos que quiero dentro del diccionario
...
for a, b, c, d, e, f, g in zip(calc, w, Error, SubHarmonics, DistHz, S_n, Error2):
